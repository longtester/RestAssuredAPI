...
public class DemoVerifyUseThenMethod {
    ...
    public void testVerifyResponseUseThenMethod() {
        ...
        int id = 363; // ID của book. Gắn vào sau path url
        ...
        response.then().body("response.name", containsString("validname65496"));
        response.then().body("response.price", equalTo(3000));
